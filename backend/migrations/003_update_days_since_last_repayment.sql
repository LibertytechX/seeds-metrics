-- Migration: Add days_since_last_repayment calculation to loan metrics trigger
-- This migration updates the update_loan_computed_fields() function to:
-- 1. Track the last payment date (MAX payment_date)
-- 2. Calculate days_since_last_repayment as CURRENT_DATE - last_payment_date
-- 3. Update the loans table with this value
