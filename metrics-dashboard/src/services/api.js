...
class ApiService {
  ...
  transformOfficerData(officer) {
    return {
      ...
      supervisorEmail: officer.supervisor_email || null,
      supervisorName: officer.supervisor_name || null,
      verticalLeadEmail: officer.vertical_lead_email || null,
      verticalLeadName: officer.vertical_lead_name || null,
